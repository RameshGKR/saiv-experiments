...
refine = 2
# Change this to either 0.1 or 0.01 accordingly
Ts = 0.1
...
t_ctrl       = np.concatenate([np.linspace(0,12,121), np.linspace(12,18,61), np.linspace(18,30,121)])
...
hyperparameterfile = 'DSL_truck_trailer_multi_stage_model_loop_0p1_prune01_slow0_run_relu\\try\\output_NN_hypertuning\\hyperparameterfile'
datafile = 'DSL_truck_trailer_multi_stage_model_loop_0p1_prune01_slow0_run_relu\\try\\dataset.csv'
modelweights = 'DSL_truck_trailer_multi_stage_model_loop_0p1_prune01_slow0_run_relu\\try\\output_NN_training\\dnn_modelweigths.h5'
