...
from imp_truck_trailer_DSL import Truck_Trailer_Use_case, standalone_simulate_function, initialize_ocp, General_Simulation_parameters
...
def run_DSL_operation():
    use_case = Truck_Trailer_Use_case()
    use_case.set_self_parameters()

    output_map = 'DSL_truck_trailer_run_1'
    ...
    Dagger(train_NN, simulate_system_traces, validate_datasets, validate_trace_datasets, expert_policy, 'Truck_trailer_data\\truck_trailer_start_dataset.csv', 'Truck_trailer_data\\truck_trailer_start_points.csv', 'Truck_trailer_data\\truck_trailer_trace_dataset.csv', 100, 100, 0.5, output_map)
